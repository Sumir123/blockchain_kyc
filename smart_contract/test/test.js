...
describe("Token Contract", function () {
  ...
  describe("Deployment", function () {
    it("Should set the right owner", async function () {
      // Call the 'admin' function to get the owner address from the contract
      const contractOwner = await hardhatToken.admin();
      // Compare the retrieved owner address with the expected owner address
